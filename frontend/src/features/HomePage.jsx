        ...
        <div className="hero">
          <div>
            ...
            <p className="hero-copy">
              ...
              should shape up. Dive into driver head-to-heads, calendar context, and the fastest laps of the year with
            ...
            <div className="meta-grid" style={{ marginTop: 'var(--space-3)' }}>
              <div className="pill">
                {progressPct !== null ? `${progressPct}% of ${totalRaces || '—'} rounds logged` : 'Loading calendar...'}
              </div>
              <div className="pill">
                {nextRace
                  ? `Next: ${nextRace.name} · ${nextRace.country ?? nextRace.location ?? ''}`
                  : lastRace
                    ? `Last run: ${lastRace.name}`
          ...
          <div className="hero-visual">
            <div className="sparkline">
              <div className="sparkline-row">
                <span className="sparkline-label">Season progress</span>
              ...
              <div className="sparkline-row">
                <span className="sparkline-label">Next stint</span>
                <div className="sparkline-bar">
                  <span
                    style={{
                      width: `${Math.min(100, Math.max(12, countdownDays ? 100 / (countdownDays + 1) : 0))}%`,
                    }}
                  />
                </div>
                <span className="spark">
                  {nextRace
                    ? `${countdownDays}d to lights out`
                    : lastRace
                      ? 'Season complete'
                      : '—'}
                </span>
